...
<form method="post" action="?p=trx_reservasi8" class="form-horizontal" >

		<div class="form-group">
			<label class="col-sm-3 col-sm-3 control-label text-right">Dari Tanggal :</label>
			<div class="col-sm-9">
			              <div class="input-group date " >
                    <input class="form-control" size="16" type="text" name="dari"   required="required" oninvalid="this.setCustomValidity('Silahkan Masukan Tanggal !!!')" oninput="setCustomValidity('')" readonly="readonly" value="<?php echo $thi ; ?>" >
		...
		<div class="form-group">
			<label class="col-sm-3 col-sm-3 control-label text-right">Sampai Tanggal :</label>
			<div class="col-sm-9">
